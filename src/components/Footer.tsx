...
export default function Footer() {
  return (
    <footer className="bg-[#4a3a30] text-gray-300 mt-16">
      ...
      <div className="max-w-7xl mx-auto grid grid-cols-4 gap-12 px-10 py-12">
        ...
        <div>
          ...
          <p className="text-sm leading-relaxed">
            Chúng tôi tôn vinh giá trị của đôi bàn tay Việt, mang đến
            những sản phẩm thủ công tinh xảo và độc bản.
          </p>
      ...
      {/* Divider */}
      <div className="border-t border-[#6b5a4f] max-w-7xl mx-auto"></div>
